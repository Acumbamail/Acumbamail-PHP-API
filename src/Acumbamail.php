...
class Acumbamail
{
     ...
     * Parameters:
     * list_id = Identificador de la lista
     * merge_fields = Diccionario que contenga los merge tags del suscriptor como claves y el valor que se quiere
     * agregar al suscriptor Example: addSubscriber("1000", array(
